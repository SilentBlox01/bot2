...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    .addField("• Developer", `\`\`\`yml\nName: !      PROFESSOR [921544143262580777]\nName Ξ Nezha 69 [921544143262580777]\`\`\``)
    .addField("• Important Links", `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)\`|\`[Support Server](https://discord.gg/S3MrBqRc64)\`|\`[Youtube](https://m.youtube.com/channel/UCvDvK4X8-3qCTE6Dl1ZHj6A)\`**`)
